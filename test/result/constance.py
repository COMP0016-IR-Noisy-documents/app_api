...
filter_type_one_element = {"language":["sl","de","es"],"type":["docx"]}
filter_lang_one_element = {"type": [], "language": ["sl"]}
filter_general = {"language":["sl","de","es"],"type":["docx","odt","rtf","txt","docx","odt","rtf","txt"]}

mod_filter_type_null= [{"terms": {"type": ["pdf"]}}]

mod_filter_lang_null = [{"terms": {"language": ["sl"]}}]
            
mod_filter_type_one_element =  [{"terms": {"type": ["docx"]}}, {"terms": {"language": ["sl", "de", "es"]}}]

mod_filter_lang_one_element = [{"terms": {"language": ["sl"]}}]

mod_filter_general = [ {"terms": {"type": ["docx","odt","rtf","txt","docx","odt","rtf","txt"]}}, {"terms": {"language": ["sl","de","es"]}}]

search_filter_one = [{"terms": {"language": ["fr"]}}, {"terms": {"type": ["mp4"]}}]
search_filter_two = [{"terms": {"language": ["fr", "en"]}}]
search_filter_three = [{"terms": {"language": ["fr", "en"]}}, {"terms": {"type": ["mp4"]}}]
